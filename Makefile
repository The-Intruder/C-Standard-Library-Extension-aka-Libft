...
SRCS_DIR := srcs/
SRCS_LST := ft_atoi.c ft_bzero.c ft_calloc.c ft_isalnum.c \
	...
	ft_lstnew.c ft_lstsize.c ft_strcmp.c ft_isspace.c ft_abs.c\
	ft_intlen.c ft_clear_console.c ft_atol.c ft_strcmp.c
